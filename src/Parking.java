...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Reservation begins");

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel14.setText("Reservation ends");

        jDateChooser1.setDateFormatString("MMM dd, yyyy");

        jDateChooser2.setDateFormatString("MMM dd, yyyy");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Honda", "Ford", "Toyota", "Tesla", "Chevrolet", "Hyundai", "Tata" }));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)), "Spots Taken", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 102))); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)), "Total Spots Reserved", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(51, 0, 102))); // NOI18N
        ...
        jButton9.setIcon(new javax.swing.ImageIcon("C:\\Users\\james\\Downloads\\Automated\\Automated\\img\\car1.png")); // NOI18N
        ...
        jButton10.setIcon(new javax.swing.ImageIcon("C:\\Users\\james\\Downloads\\Automated\\Automated\\img\\inside-logout-icon-1.png")); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\james\\OneDrive\\Documents\\NetBeansProjects\\ParkingGAutomation\\Parklogo.jpg")); // NOI18N
        ...
        setSize(new java.awt.Dimension(982, 739));
...
System.out.println("Error in insert"+ex);
    ...
    private void UpdateTable(){
        try{
        String sql="select license as LICENSE,name as Name,issue as Park_Date,expiry as Release from parked Order by Name";
        pst=conn.prepareStatement(sql);
        rs=pst.executeQuery();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     int p=JOptionPane.showConfirmDialog(null, "Are you sure", "Release", JOptionPane.YES_NO_OPTION);
        if(p==0){
            String sql="delete from parked where license=?";
            try{
                pst=conn.prepareStatement(sql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
     try{
            String sql="insert into parked (license,name,gender,position,brand,issue,expiry,lapn,trackn) values (?,?,?,?,?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
    ...
    private void rel(){
      try{
            String sql="insert into released (license,name,gender,position,brand,issue,expiry,lapn,trackn) values (?,?,?,?,?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            pst.setString(2, jTextField2.getText());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            String sql="select * from parked where license='"+Table_click+"'";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
                String add1=rs.getString("license");

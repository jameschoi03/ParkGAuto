...
ResultSet rs;
    ...
    public Released() {
        ...
        UpdateTable();
        String a="<html><u>Welcome to ParkGAuto</u></html>";
        jLabel1.setText(a);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Completed Reservations");
        ...
        setSize(new java.awt.Dimension(765, 580));
     ...
     private void UpdateTable(){
        try{
        String sql="select license as LICENSE,name as Name,issue as Park_Date,expiry as Release from released Order by Name";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            String sql="select * from released where license='"+Table_click+"'";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
